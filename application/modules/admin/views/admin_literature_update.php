        ...
        <div class="action_form">
            ...
            <?php
				if(trim($literature_array[0]->thumbnail) != '') {
					echo '&nbsp;&nbsp;Current Download File: <a class="lightbox" href="/downloads/thumbs/' . $literature_array[0]->thumbnail . '.' . $literature_array[0]->thumbnail_extension . '?rand=' . $random . '">' . $literature_array[0]->thumbnail . '.' . $literature_array[0]->thumbnail_extension . '</a>';
				}
			?>
            ...
            <?php
				if(trim($literature_array[0]->filename) != '') {
					echo '&nbsp;&nbsp;Current Download File: <a href="/downloads/' . $literature_array[0]->filename . '.' . $literature_array[0]->extension . '?rand=' . $random . '" target="_blank">' . $literature_array[0]->filename . '.' . $literature_array[0]->extension . '</a>';
				}
			?>
