...
<section class="page-row page-row--snug bg-grey ps-welcome-wrapper">
    <header class="intro-statement intro-statement--squeezed">
        <h1 class="normal-weight">Commercial SUN TUNNEL Night</h1>
    </header>
...
<section class="page-row short-top snug-bottom product-statement">
    ...
    <div class="row">
        <div class="small-12 medium-8 columns full-tablet border-bottom-grey statement">
            <h4 class="normal-weight">All VELUX commercial SUN TUNNEL&trade; skylights provide a cost-effective method to pass natural daylight through the roof to help light the interior and reduce energy loads. They also improve the occupant’s performance, mood and comfort. </h4>
...
<section class="page-row short-top snug-bottom ps-section benefits">
    <div class="row">
        <div class="small-12 medium-8 columns full-tablet cta-padding border-bottom-grey">
            <h4 class="normal-weight underlined color-primary">All VELUX commercial SUN TUNNEL skylights feature: </h4>
            <ul class="ps-list">
...
<section class="page-row short-top snug-bottom ps-section benefits">
    <div class="row">
        <div class="small-12 medium-8 columns full-tablet cta-padding border-bottom-grey">
            ...
            <h4 class="normal-weight underlined color-primary">Features of the TCR model include:  </h4>
            <ul class="ps-list">
