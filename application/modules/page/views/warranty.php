...
?>
	<section class="page-row">
		...
		<p class="text-columns installer-warranty"><?= filter_page_content($warranty_array[0]->dealer_warranty); ?></p>
	</section>
<?php
	}
?>
