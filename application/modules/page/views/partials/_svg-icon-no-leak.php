<i class="icon icon-no-leak" data-inline-svg-fallback="<?=asset_url('images/sprites/sprite.svg.icon-no-leak.png')?>">
<svg id="icon-no-leak" viewBox="452.5 449.5 95 101" xml:space="preserve">
