...
<?php echo form_open('/installer-admin/profile/update-password/' . $user_id); ?>
...
<div id="action_form_wrapper">
    <div class="action_form">
        ...
        <div class="action_form_submit_cancel clearfix">
            <input type="submit" name="action" id="update_password" rel="update_password" value="Update Password" class="blue_button submit submit" /><a href="/installer-admin/home" class="cancel_button">Cancel</a>
        </div>
